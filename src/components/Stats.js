...
const Stats = () => {
  return (
    <div>
      <section className="bg-[#FDFBCF] py-16">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="mt-16">
            <h3 className="text-2xl font-semibold mb-8 text-gray-800">Our Top Investors</h3>

            <div className="grid gap-8 text-left sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
              <div className="text-lg font-medium text-gray-700 pl-4">
                Morgan Stanley
              </div>
              <div className="text-lg font-medium text-gray-700 pl-4">
                Cav Master
